...
python /home/2024/aberni24/Courses/COMP551/Assignment4/scripts/example.py   
...
# 2. module load slurm
# 3. sbatch abs path to this script Eg. sbatch /home/2024/aberni24/Courses/COMP551/Assignment4/scripts/run_example.sh